                ...
                if (
                    ...
                    for metadata_key in component.execution.metadata:
                        if (
                            ...
                            or (component.state == gca_pipeline_job_v1.PipelineTaskDetail.State.SKIPPED and component.execution.state == gca_execution_v1.Execution.State.CACHED)
                            )
                        ):
