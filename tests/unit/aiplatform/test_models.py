...
class TestModel:
    ...
    @pytest.mark.parametrize("sync", [True, False])
    def test_copy_as_new_model(self, copy_model_mock, get_model_mock, sync):
        my_model = models.Model.copy(
    ...
    @pytest.mark.parametrize("sync", [True, False])
    def test_copy_as_new_version(self, copy_model_mock, get_model_mock, sync):
        my_model = models.Model.copy(
            source_model=_TEST_MODEL_RESOURCE_NAME,
            parent_model=_TEST_MODEL_RESOURCE_NAME,
            sync=sync,
        )
    ...
    @pytest.mark.parametrize("sync", [True, False])
    def test_copy_as_new_model_custom_id(self, copy_model_mock, get_model_mock, sync):
        my_model = models.Model.copy(
            source_model=_TEST_MODEL_RESOURCE_NAME,
    ...
    @pytest.mark.parametrize("sync", [True, False])
    def test_copy_with_invalid_params(self, copy_model_mock, get_model_mock, sync):
        with pytest.raises(ValueError) as e:
            models.Model.copy(
                source_model=_TEST_MODEL_RESOURCE_NAME,
                model_id=_TEST_MODEL_ID,
        ...
        assert e.match(regexp=r"`model_id` and `parent_model` can not be set together.")
